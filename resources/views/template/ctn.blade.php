...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('img/Saad.jpg') }}">
    ...
    <section class="contact-section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form action="{{ route('template.message') }}" method="POST" class="form-contact contact_form">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <input class="form-control" name="objet" id="objet" type="text" placeholder="Enter Subject">
                                    </div>
                                </div>
                            </div>
